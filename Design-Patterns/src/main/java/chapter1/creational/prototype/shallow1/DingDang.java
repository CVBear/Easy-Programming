...
/**
 * @Classname DingDang
 * @Description 具体原型类: 叮当
 * @Compiler CVBear
 * @Date 2020/7/23 9:29
 */
public class DingDang implements Prototype {
    /*叮当的经*/
    ...
    public Prototype clone() {
        ...
        dingDang.setSkill(this.skill);//浅拷贝
//        dingDang.setSkill(dingDang.getSkill().clone());//深拷贝
        dingDang.setAge(this.age);
        dingDang.setSharpTooth(this.sharpTooth);
        dingDang.setTail(this.tail);
        dingDang.setSex(this.sex);
        return dingDang;
    }
